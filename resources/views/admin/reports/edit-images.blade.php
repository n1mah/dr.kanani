    ...
    <div id="main">
        ...
        <div class="body">
            ...
            <div id="edit-special-prescription-page">
                <h1> ویرایش تصاویر گزارش / آزمایش </h1>
                <br>
                <form action="{{route("report.image.store",$report)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <br>
                ...
                <div class="show-images">
                    ...
                    <br>
                    برای حذف هر کدام روز دکمه آن بزنید</p>
                    <br>
                    <div class="parent-box">
                        @foreach($report->report_images as $image)
                            <div class="box">
                                ...
                                <form action="{{route("report.image.delete",$image)}}" method="post">
                                    @csrf
                                    @method('delete')
